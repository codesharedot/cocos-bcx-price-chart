...
r  = requests.get("https://coinmarketcap.com/currencies/molecular-future/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('molecular-future price from 2014')
