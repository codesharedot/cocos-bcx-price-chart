...
r  = requests.get("https://coinmarketcap.com/currencies/dxchain-token/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('dxchain-token price from 2014')
