...
r  = requests.get("https://coinmarketcap.com/currencies/power-ledger/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('power-ledger price from 2014')
