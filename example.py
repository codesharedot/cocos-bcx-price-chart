...
r  = requests.get("https://coinmarketcap.com/currencies/bibox-token/historical-data/?start=20140101&end={0}".format(enddate))
data = r.text
...
plt.title('bibox-token price from 2014')
